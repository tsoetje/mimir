...
func initPools(tracker *refleaks.Tracker) {
	preallocTimeseriesSlicePool = refleaks.NewInstrumentedZeroPool(tracker, func(r *refleaks.Reserver) {
		refleaks.Reserve[PreallocTimeseries](r, minPreallocatedTimeseries)
	}, func(a *refleaks.Allocator) []PreallocTimeseries {
		return make([]PreallocTimeseries, 0, minPreallocatedTimeseries)
	})

	timeSeriesPool = refleaks.NewInstrumentedSyncPool(tracker, func(r *refleaks.Reserver) {
		refleaks.Reserve[LabelAdapter](r, minPreallocatedLabels)
		refleaks.Reserve[Sample](r, minPreallocatedSamplesPerSeries)
		refleaks.Reserve[Exemplar](r, minPreallocatedExemplarsPerSeries)
	}, func(a *refleaks.Allocator) any {
		return &TimeSeries{
	...
	yoloSlicePool = refleaks.NewInstrumentedSyncPool(tracker, func(r *refleaks.Reserver) {
		refleaks.Reserve[byte](r, minPreallocatedYoloSliceBytes)
	}, func(a *refleaks.Allocator) any {
